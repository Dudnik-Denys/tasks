...
def iteration_by_sequence(sequence: list | tuple, index=0):
    if len(sequence) > 0:
        print(f'Элемент {index}: {sequence[0]}')
        iteration_by_sequence(sequence[1:], index=index + 1)


iteration_by_sequence(numbers)
